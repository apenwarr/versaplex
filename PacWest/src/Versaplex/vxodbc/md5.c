 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvsroot/psqlodbc/psqlodbc/md5.c,v 1.12 2006/09/13 15:30:27 hinoue Exp $
 */
 ...
 */
static uint8 *createPaddedCopyWithLength(uint8 * b, uint32 * l)
{
    uint8 *ret;
    uint32 q;
 ...
 *
 */
bool md5_hash(const void *buff, size_t len, char *hexsum)
{
    uint8 sum[16];
